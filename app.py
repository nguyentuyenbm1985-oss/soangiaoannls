...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Thị Tuyền - Trường PTDTBT Tiểu học Đường Âm - ĐT: 097 1986 343</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Thi Tuyền - Trường PTDTBT Tiểu học Đường Âm - ĐT: 097 1986 343</div>", unsafe_allow_html=True)
